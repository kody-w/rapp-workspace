...
def run_demo(core, output, *, fixture=None, rights=None, show=print):
    ...
    with patch.object(core.r.uuid, "uuid4", return_value=uuid.UUID(int=20260915, version=4)):
        instance = core.r.mint_rappid("fictional", "safe-grail-demo")
    ...
    try:
        ...
        if "local_synthesis" not in allowed:
            ...
            if fixture is None:
                ...
                adopted = True
            report = {"profile": PROFILE, "brand": "RAPP Workspace/1 Grail",
                      "status": "minimal-safe-kernel-candidate", "guarantees": states,
                      "adopted_inert_captured_view": adopted, "native_rebinding": False,
                      "learned_semantic_capability": "disabled-unproven", "signed_grail_activation": False}
...
def main():
    ...
    parser.add_argument("--output", type=Path, default=Path(".validation/first-grail-safe-demo"))
