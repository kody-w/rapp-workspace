"""Closed first-Grail safety-kernel contracts; no experimental version aliases."""
...
URI = "https://github.com/kody-w/rapp-workspace/raw/main/protocols/rapp-workspace/grail-1.0/schemas/"
...
def schemas():
    ...
    records = {
        "seed": record("seed", generation=fixed("first-grail"), spec_sha256=ref("hash"),
...
def main():
    ...
    print(f"{len(schemas())} first-Grail schemas | " + ("FAIL " + ", ".join(bad) if bad else "PASS"))
    return bool(bad)
