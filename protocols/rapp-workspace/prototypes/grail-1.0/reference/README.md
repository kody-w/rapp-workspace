# First-Grail safe reference

Normative ID: `rapp-workspace/grail-1.0`. Brand: **RAPP Workspace/1 Grail**.
...
coherent native snapshot semantics. First-Grail adoption of native-backed
...
The blocking matrix covers every P0/P1 requirement. `experimental/` contains
withdrawn research, disabled unless explicitly opted in, and is never imported
by the safe entry point. Its regression passes are not first-Grail acceptance.
