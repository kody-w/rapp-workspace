...
| Module | Does |
|---|---|
| `rapp1` | RAPP/1 canonical JSON, particles and waves, RAPPIDs, detached EdDSA JWS, stream ownership |
...
| `migrate` | Path A (`rapp-hive/1`) and Path B (seeded join requests) plans, and signing one's own steps |
